...
function nextQuestion() {
  ...
  if (currentQuestionIndex < shuffledQuestions.length - 1) {
    ...
    // Show the "Show Results" button when the quiz is completed
    document.getElementById("results-btn").classList.remove("hide");
  }
}

function showResults() {
  // Store the shuffled questions in localStorage
